# 17.3.0
## Features
- IFS-3118: Eingabefeld für ungewisses Datum `isy-incomplete-date` kann nun Datumswerte in ISO 8601 für die Datenübertragung ausgeben. Validator für ungewisses Datumswert in ISO 8601 wurde zur Bibliothek hinzugefügt
