...
/**
 * The service is responsible for translating PrimeNG Calendar.
 */
@Injectable({
    providedIn: 'root'
  })
export class TranslateCalendarService {
  ...
  public translateCalendar(locale: Locale): void {
    this.primengConfig.setTranslation(this.localized[locale]);
  }
}
