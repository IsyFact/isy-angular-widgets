!(function () {
  ...
  function m(e) {
    var n = '<>',
      ...
      o =
        ((o.contains = [e.APOS_STRING_MODE, e.QUOTE_STRING_MODE, c, d, g, l, e.REGEXP_MODE]),
    ...
    return {
      ...
      contains: [
        ...
        l,
        {
          ...
          relevance: 0,
          contains: [
            {begin: s + '\\s*:', returnBegin: !0, relevance: 0, contains: [{className: 'attr', begin: s, relevance: 0}]}
          ]
        },
        {
              ...
              contains: [
                {
                  ...
                  variants: [
                    {begin: s},
                    {begin: /\(\s*\)/},
                    {begin: /\(/, end: /\)/, excludeBegin: !0, excludeEnd: !0, keywords: r, contains: o}
                  ]
                }
              ]
            },
  ...
  function b(e) {
    var n = '[A-Za-z_\\u00A1-\\uFFFF][A-Za-z_0-9\\u00A1-\\uFFFF]*',
      ...
      i = {className: 'string', contains: [e.BACKSLASH_ESCAPE, t, i], begin: '`', end: '`'};
    return (
      (a.contains = [
        {
          className: 'number',
    ...
    return {
      ...
      contains: [
        ...
        {begin: /(::|->)+[a-zA-Z_\x7f-\xff][a-zA-Z0-9_\x7f-\xff]*/},
        {
          ...
          contains: [
            e.UNDERSCORE_TITLE_MODE,
            {className: 'params', begin: '\\(', end: '\\)', contains: ['self', n, e.C_BLOCK_COMMENT_MODE, t, i]}
          ]
        },
        {
          className: 'class',
  ...
  function x(e) {
    ...
    return (
      (s.contains = r),
      {
        ...
        contains: t
          .concat([
            {begin: /^\s*=>/, starts: {end: '$', contains: (l.contains = r)}},
            {
              className: 'meta',
  ...
  (D = function (t) {
    var a,
      ...
      x = {classPrefix: 'hljs-', tabReplace: null, useBR: !1, languages: void 0},
    ...
    function A(n, e, t, a) {
      ...
      function s(e, n, a, t) {
        return a || '' !== n
          ? e
            ? ((t = '<span class="' + (t ? '' : x.classPrefix)), (t += e + '">') + n + (a ? '' : O))
            : n
          : '';
      }
      function r() {
        ...
        for (a = '', _.lexemesRe.lastIndex = e = 0, n = _.lexemesRe.exec(E); n; )
      ...
      function d(e) {
        ...
        if (a) {
          e = _;
          for (
            e.skip ? (E += n) : (e.returnEnd || e.excludeEnd || (E += n), l(), e.excludeEnd && (E = n));
            _.className && (p += O), _.skip || _.subLanguage || (N += _.relevance), (_ = _.parent) !== a.parent;
      ...
      var m = R(n);
      if (!m) throw (console.error(C.replace('{}', n)), new Error('Unknown language: "' + n + '"'));
      T(m);
      ...
      try {
        ...
        if (M) return {relevance: 0, value: S(i), language: n, top: _, errorRaised: e};
        throw e;
      }
    }
    function k(a, e) {
    ...
    function N(e) {
      var n,
        ...
        s = (function (e) {
          var n,
            ...
            s,
            r = e.className + ' ';
          if (((r += e.parentNode ? e.parentNode.className : ''), (a = l.exec(r))))
            return (
              (s = R(a[1])) ||
      ...
      c(s) ||
        ...
        (i = a.textContent),
        (n = s ? A(s, i, !0) : k(i)),
        (a = m(a)).length && (((t = document.createElement('div')).innerHTML = n.value), (n.value = _(a, m(t), i))),
        (n.value = E(n.value)),
        (e.innerHTML = n.value),
        (e.className =
          ((a = e.className),
    ...
    return (
      ...
      (t.COMMENT = function (e, n, a) {
        ...
        return (
          ...
          e.contains.push({className: 'doctag', begin: '(?:TODO|FIXME|NOTE|BUG|XXX):', relevance: 0}),
          e
        );
      }),
